...
export interface StrokePath {
  d: string;             // SVG path d="..."
  direction: '→' | '←' | '↓' | '↑' | '↘' | '↙' | '↗' | '↖' | '↻' | '↺' | '·';
  hint: string;           // человеческое описание (например "横 — слева направо")
}
...
export const kanjiStrokes: Record<string, StrokePath[]> = {
  ...
  '水': [
    ...
    { d: 'M 14 75 L 50 100 M 50 100 Q 65 90 50 80', direction: '↘', hint: '3. Левый бросок (пробка)' },
  ...
  '駅': [
    ...
    { d: 'M 30 14 L 30 86 M 80 14 L 80 86 M 60 14 L 60 50 L 35 86', direction: '↓', hint: '4-7. «馬» вертикали и диагональ' },
